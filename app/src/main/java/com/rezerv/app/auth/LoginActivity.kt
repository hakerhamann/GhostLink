...
class LoginActivity : AppCompatActivity() {
    ...
    private fun setupRememberedAccountsSelector() {
        ...
        binding.acRememberedAccounts.setDropDownBackgroundResource(R.drawable.bg_dropdown_menu)
    ...
    private fun refreshRememberedAccountsSelector() {
        val serverUrl = AppContainer.sessionStore.getServerUrl()
        ...
        val adapter = ArrayAdapter(this, R.layout.item_login_dropdown, labels)
